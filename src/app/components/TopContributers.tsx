            ...
            <div className="bg-background relative flex max-h-[400px] min-h-[400px] w-full max-w-[32rem] flex-col overflow-hidden rounded-lg bg-white/10 p-6 shadow-lg">
                <div className="flex items-center justify-center h-full">
                    <div className="text-center">
                        <h3 className="text-lg font-semibold mb-2 text-white">No Contributors Available</h3>
                        <p className="text-gray-400 text-sm">Connect to Appwrite to see top contributors</p>
                    </div>
                </div>
            </div>
        );
